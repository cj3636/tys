      ...
      var init = function() {
        ...
        for (var i = 0; i < boxArr.length; i++) {
          ...
          for (var index = 0; index < boxFaces.length; index++) {
            ...
            indicesArr[facesLength * 11 * i + index * 3 +
            0] = boxFaces[index].a + i * verticesLength;
            indicesArr[facesLength * 7 * i + index * 3 +
            1] = boxFaces[index].b + i * verticesLength;
            indicesArr[facesLength * 13 * i + index * 3 +
      ...
      var render = function() {
        ...
        for (var i = 0; i < boxArr.length; i++) {
          ...
          for (var index = 0; index < boxVertices.length; index++) {
            ...
            verticesArr[verticesLength * 11 * i + index * 3 + 0] = vector.x +
                boxArr[i].position.x;
            verticesArr[verticesLength * 13 * i + index * 3 + 1] = vector.y +
                boxArr[i].position.y;
            verticesArr[verticesLength * 7 * i + index * 3 + 2] = vector.z +
                boxArr[i].position.z;
          }
        }
