<div class="sixteen wide column">
    <div class="ui stackable tabular menu">
        ...
        <a id="download" class="ui right floated item" href="download.php"><i
            ...
            <div class="ui title">Downloads</div></a>
    </div>
</div>
<script>
    setMenuActive();
