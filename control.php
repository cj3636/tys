...
if (!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] != 1) {
    ...
    <div id="page" class="ui stackable grid">
        <div class="center aligned twelve wide column">
            ...
            <div class="ui blue header">Pressing submit will immediately overwrite the text for that field on its resctive page. Use carefully.
            </div>
            <form class="ui form" action="/admin/init.php" method="POST">
