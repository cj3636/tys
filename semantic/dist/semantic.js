      ...
      module = {
        ...
        bindEvents: function() {
          ...
          if (settings.keyboardShortcuts) {
            $module.on('keydown' + eventNamespace, selector.field,
          ...
          prompt: function(rule, field) {
            var
                ...
                prompt = $.isFunction(rule.prompt)
                    ...
                    rule.prompt(value)
                    :
                    rule.prompt || settings.prompt[ruleName] ||
          ...
          if (typeof query == 'string' && object !== undefined) {
            ...
            $.each(query, function(depth, value) {
              ...
              if ($.isPlainObject(object[camelCaseValue]) &&
                ...
                found = object[camelCaseValue];
                return false;
              } else if ($.isPlainObject(object[value]) &&
                  (depth != maxDepth)) {
                object = object[value];
              } else if (object[value] !== undefined) {
                found = object[value];
      ...
      module = {
        ...
        bind: {
          events: function() {
            ...
            $module.on(settings.on + eventNamespace, selector.trigger,
                module.event.click)
            ;
          },
        },
        ...
        open: function(query) {
          ...
          $activeContent.slideDown(settings.duration, settings.easing,
              function() {
                $activeContent.removeClass(className.animating).
        ...
        close: function(query) {
          ...
          if ((isActive || isOpening) && !isClosing) {
            ...
            $activeContent.slideUp(settings.duration, settings.easing,
                function() {
                  $activeContent.removeClass(className.animating).
        ...
        closeOthers: function(index) {
          var
              $activeTitle = (index !== undefined)
                  ? $title.eq(index)
                  : $(this).closest(selector.title),
              $parentTitles = $activeTitle.parents(selector.content).
              prev(selector.title),
          ...
          if (settings.closeNested) {
            $openTitles = $activeAccordion.find(activeSelector).
            not($parentTitles);
            $openContents = $openTitles.next($content);
          } else {
            $openTitles = $activeAccordion.find(activeSelector).
            not($parentTitles);
            $nestedTitles = $activeAccordion.find(activeContent).
            find(activeSelector).
            not($parentTitles);
          ...
          if (($openTitles.length > 0)) {
            ...
            $openContents.slideUp(settings.duration, settings.easing,
                function() {
    ...
    $allModules.each(function() {
      ...
      module = {
        ...
        bind: {
          events: function() {
            if (settings.on == 'hover') {
              $dimmable.on('mouseenter' + eventNamespace, module.show).
            ...
            if (module.is.closable()) {
              ...
              $dimmable.on(clickEvent + eventNamespace, selector.dimmer,
                  module.event.click)
              ;
            }
          },
        ...
        has: {
          dimmer: function() {
            if (settings.dimmerName) {
              return ($module.find(selector.dimmer).
              filter('.' + settings.dimmerName).length > 0);
            } else {
      ...
      module = {
        ...
        select: {
          firstUnfiltered: function() {
            ...
            $item.not(selector.unselectable).
          ...
          nextAvailable: function($selected) {
            ...
            var
                $nextAvailable = $selected.nextAll(selector.item).
                not(selector.unselectable).
                eq(0),
                $prevAvailable = $selected.prevAll(selector.item).
                not(selector.unselectable).
                eq(0),
        ...
        bind: {
          ...
          touchEvents: function() {
            ...
            if (module.is.searchSelection()) {
              ...
              $module.on('touchstart' + eventNamespace,
                  module.event.test.toggle)
              ;
            }
            $menu.on('touchstart' + eventNamespace, selector.item,
          ...
          keyboardEvents: function() {
            ...
            if (module.has.search()) {
              $module.on(module.get.inputEvent() + eventNamespace,
                  selector.search, module.event.input)
              ;
            }
            if (module.is.multiple()) {
              $document.on('keydown' + elementNamespace,
          ...
          inputEvents: function() {
            ...
            $module.on('change' + eventNamespace, selector.input,
                module.event.change)
            ;
          },
          mouseEvents: function() {
            ...
            if (module.is.multiple()) {
              $module.on('click' + eventNamespace, selector.label,
            ...
            if (module.is.searchSelection()) {
              $module.on('mousedown' + eventNamespace, module.event.mousedown).
              ...
              if (settings.on == 'click') {
                ...
                $module.on('mouseenter' + eventNamespace, module.delay.show).
              ...
              $module.on('click' + eventNamespace, selector.icon,
                  module.event.icon.click).
              ...
              ;
              if (module.has.menuSearch()) {
                $module.on('blur' + eventNamespace, selector.search,
                    module.event.search.blur)
                ;
              } else {
            ...
            $menu.on('mouseenter' + eventNamespace, selector.item,
                module.event.item.mouseenter).
          ...
          intent: function() {
            ...
            if (hasTouch) {
              $document.on('touchstart' + elementNamespace,
            ...
            $item.each(function() {
              ...
              if (settings.match == 'both' || settings.match == 'text') {
                ...
                if (text.search(beginsWithRegExp) !== -1) {
                  ...
                  results.push(this);
                  return true;
                } else if (settings.fullTextSearch === true &&
        ...
        fuzzySearch: function(query, term) {
          ...
          search: for (var characterIndex = 0, nextCharacterIndex = 0; characterIndex <
          queryLength; characterIndex++) {
            var
        ...
        forceSelection: function() {
          var
              $currentlySelected = $item.not(className.filtered).
              filter('.' + className.selected).
              eq(0),
              $activeItem = $item.not(className.filtered).
        ...
        event: {
            ...
            click: function(event) {
              var
                  ...
                  $range = ($nextActive.length > 0)
                      ?
                      $label.nextUntil($nextActive).
                      add($activeLabels).
                      add($label)
                      :
                      $label.prevUntil($prevActive).
                      add($activeLabels).
                      add($label)
              ;
              if (event.shiftKey) {
          ...
          item: {
            mouseenter: function(event) {
              var
                  ...
                  $otherMenus = $item.siblings(selector.item).
                  ...
                  if (hasActiveLabel) {
                    ...
                    if (isLastLabel) {
                      if (isSearch) {
                        ...
                        $activeLabel.next(selector.siblingLabel).
                        addClass(className.active);
                      } else {
                        $activeLabel.addClass(className.active);
                      }
          ...
          keydown: function(event) {
            ...
            if (isShortcutKey) {
              var
                  $currentlySelected = $item.not(selector.unselectable).
                  filter('.' + className.selected).
                  eq(0),
                ...
                if (hasSelectedItem) {
                  ...
                  if (pressedKey == keys.leftArrow) {
                    ...
                    if (isSubMenuItem) {
                      ...
                      ;
                      $parentMenu.closest(selector.item).
                      addClass(className.selected)
                      ;
                      event.preventDefault();
                    }
        ...
        get: {
          ...
          selectedItem: function() {
            var
                $selectedItem = $item.not(selector.unselectable).
                filter('.' + className.selected)
            ;
        ...
        add: {
          label: function(value, text, shouldAnimate) {
            ...
            if (shouldAnimate === true) {
              ...
              $label.addClass(className.hidden).
              insertBefore($next).
          ...
          userSuggestion: function(value) {
            ...
            if (hasUserSuggestion) {
              $addition.data(metadata.value, value).
            ...
            if (!settings.hideAdditions || module.is.allFiltered()) {
              $addition.addClass(className.selected).
              siblings().
        ...
        remove: {
          ...
          selected: function(value, $selectedItem) {
            ...
            $selectedItem.each(function() {
              ...
              $selected.removeClass(className.filtered).
              removeClass(className.active)
              ;
              if (settings.useLabels) {
        ...
        has: {
          ...
          label: function(value) {
            ...
            return ($labels.filter('[data-' + metadata.value + '="' +
                module.escape.string(escapedValue) + '"]').length > 0);
          },
        ...
        is: {
          ...
          bubbledLabelClick: function(event) {
            return $(event.target).is('select, input') &&
          ...
          alreadySetup: function() {
            return ($module.is('select') &&
                $module.parent(selector.dropdown).data(moduleNamespace) !==
                undefined && $module.prev().length === 0);
          },
          ...
          allFiltered: function() {
            return ((module.is.multiple() || module.has.search()) &&
                !(settings.hideAdditions == false &&
                    module.has.userSuggestion()) && !module.has.message() &&
                module.has.allResultsFiltered());
          },
        ...
        can: {
          ...
          openDownward: function($subMenu) {
            ...
            onScreen = {
              above: (calculations.context.scrollTop) <=
                  ...
                  calculations.context.offset.top - calculations.menu.height,
          ...
          openRightward: function($subMenu) {
            ...
            isOffscreenRight = (calculations.menu.offset.left -
                calculations.context.offset.left + calculations.menu.width >=
                calculations.context.scrollLeft + calculations.context.width);
            if (isOffscreenRight) {
              module.verbose('Dropdown cannot fit in context rightward',
                  isOffscreenRight);
        ...
        bind: {
          events: function() {
            if (module.has.placeholder()) {
              ...
              $module.on('click' + eventNamespace, selector.placeholder,
      ...
      module = {
        ...
        bind: {
          events: function() {
            ...
            $module.on('click' + eventNamespace, selector.close,
                module.event.close).
    ...
    $allModules.each(function() {
      ...
      module = {
        ...
        initialize: function() {
          ...
          $module.on('click' + eventNamespace, selector.close, module.dismiss).
      ...
      module = {
        ...
        get: {
          ...
          calculations: function() {
            ...
            calculations.target.margin.top = (settings.inline)
                ?
                parseInt(window.getComputedStyle(targetElement).
        ...
        bind: {
          events: function() {
            ...
            if (module.get.startEvent()) {
              $module.on(module.get.startEvent() + eventNamespace,
                  module.event.start).
          ...
          popup: function() {
            ...
            if ($popup && module.has.popup()) {
              $popup.on('mouseenter' + eventNamespace, module.event.start).
          ...
          closeOnScroll: function() {
            ...
            $scrollContext.one(module.get.scrollEvent() + elementNamespace,
        ...
        should: {
          centerArrow: function(calculations) {
            return !module.is.basic() && calculations.target.width <=
      ...
      module = {
        ...
        get: {
          text: function(templateText) {
            ...
            templateText = templateText.replace('{value}', value).
            replace('{total}', total).
            replace('{left}', left).
          ...
          percent: function(percent) {
            ...
            if (!module.has.total()) {
              module.value = (settings.precision > 0)
                  ?
                  Math.round((percent / 100) * module.total *
                      (10 * settings.precision)) / (10 * settings.precision)
                  :
          ...
          state: function(percent) {
            ...
            if (percent === 100) {
              if (settings.autoSuccess &&
                  !(module.is.warning() || module.is.error() ||
                      module.is.success())) {
                module.set.success();
      ...
      module = {
        ...
        event: {
          mouseenter: function() {
            ...
            ;
            $activeIcon.addClass(className.selected).
            prevAll().
            addClass(className.selected)
            ;
          },
        ...
        bind: {
          events: function() {
            ...
            $module.on('mouseenter' + eventNamespace, selector.icon,
        ...
        bind: {
          events: function() {
            ...
            if (settings.automatic) {
              $module.on(module.get.inputEvent() + eventNamespace,
                  selector.prompt, module.event.input)
              ;
        ...
        event: {
          ...
          blur: function(event) {
            ...
            if (module.resultsClicked) {
              ...
              $module.one('click.close' + eventNamespace, selector.results,
                  function(event) {
        ...
        handleKeyboard: function(event) {
          ...
          if (module.is.visible()) {
            if (keyCode == keys.enter) {
              ...
              ;
              $result.removeClass(className.active).
              eq(newIndex).
              addClass(className.active).
              closest($category).
              addClass(className.active)
          ...
          categoryResults: function(results) {
            ...
            $.each(results, function(index, result) {
              ...
              if (categoryResults[result.category] === undefined) {
                module.verbose('Creating new category of results',
                    result.category);
    ...
    $allModules.each(function() {
      ...
      module = {
        ...
        reset: function() {
          ...
          ;
          $nextSide.removeClass(className.animating).
          attr('style', '').
          removeAttr('style')
          ;
        },
        ...
        get: {
          ...
          transform: {
            ...
            left: function() {
              var
                  translate = {
                    x: -(($activeSide.outerWidth(true) -
                        $nextSide.outerWidth(true)) / 2),
      ...
      module = {
        ...
        bind: {
          clickaway: function() {
            ...
            if (settings.closable) {
              $context.on('click' + elementNamespace, module.event.clickaway).
          ...
          scrollLock: function() {
            if (settings.scrollLock) {
              ...
              $window.on('DOMMouseScroll' + elementNamespace,
                  module.event.scroll)
              ;
            }
        ...
        othersAnimating: function() {
          return ($sidebars.not($module).
          filter('.' + className.animating).length > 0);
        },
        othersVisible: function() {
          return ($sidebars.not($module).
          filter('.' + className.visible).length > 0);
        },
        ...
        hideOthers: function(callback) {
          var
              $otherSidebars = $sidebars.not($module).
    ...
    $allModules.each(function() {
      ...
      module = {
        ...
        destroy: function() {
          ...
          $window.off('load' + eventNamespace, module.event.load).
        ...
        bind: {
          events: function() {
            ...
            ;
            // pub/sub pattern
            $scroll.off('scroll' + eventNamespace).
        ...
        save: {
          ...
          positions: function() {
            ...
            module.cache = {
              fits: ((element.height + settings.offset) <=
        ...
        set: {
          ...
          size: function() {
            if (module.cache.element.height !== 0 &&
        ...
        unbind: function() {
          if (module.is.bound()) {
            ...
            module.remove.offset();
            $module.removeClass(className.bound).
            removeClass(className.top).
            removeClass(className.bottom)
            ;
          }
        ...
        unfix: function() {
          if (module.is.fixed()) {
            ...
            module.remove.offset();
            $module.removeClass(className.fixed).
            removeClass(className.top).
            removeClass(className.bottom)
            ;
            settings.onUnstick.call(element);
      ...
      module = {
        ...
        changeTab: function(tabPath) {
          var
              ...
              shouldIgnoreLoad = (pushStateAvailable &&
                  settings.ignoreFirstLoad && firstLoad),
              remoteContent = (settings.auto ||
        ...
        get: {
          initialPath: function() {
            return $allModules.eq(0).data(metadata.tab) ||
      ...
      module = {
        ...
        start: {
          animation: function(animationClass) {
            ...
            $module.addClass(animationClass).
        ...
        can: {
          transition: function(forced) {
            ...
            if (transitionExists === undefined || forced) {
              ...
              insertAfter($module);
              currentAnimation = $clone.addClass(animation).
              ...
              css('animationName')
              ;
              inAnimation = $clone.addClass(className.inward).
              css('animationName')
              ;
              if (!displayType) {
                displayType = $clone.attr('class', elementClass).
                removeAttr('style').
                removeClass(className.hidden).
      ...
      module = {
        ...
        should: {
          removeError: function() {
            return (settings.hideError === true ||
        ...
        get: {
          ...
          templatedURL: function(action) {
            action = action || $module.data(metadata.action) ||
      ...
      module = {
        ...
        bind: {
          events: function() {
            ...
            ;
            // pub/sub pattern
            $context.off('scroll' + eventNamespace).
            on('scroll' + eventNamespace, module.event.scroll).
            on('scrollchange' + eventNamespace, module.event.scrollchange)
            ;
          },
        ...
        create: {
          placeholder: function() {
            ...
            $placeholder = $module.clone(false).
            css('display', 'none').
        ...
        save: {
          ...
          elementCalculations: function() {
            ...
            // meta calculations
            element.onScreen = ((element.topVisible || element.passing) &&
                !element.bottomPassed);
