...
class PHP2HTML {
    public function createElement($dom, $tag, $class, $id = null, $text = null, $extraAttirubutes = [], $attributeValues = []) {
    ...
    public function createImg($dom, $class, $src) {
    ...
    public function createDiv($dom, $class, $text = '') {
        $div = $dom->createElement('div', $text);
        $div->setAttribute('class', $class);
        return $div;
    }

    public function createa($dom, $href, $target) {
    ...
    public function createIcon($dom, $class) {
        return createElement($dom, 'i', $class, null);
    }

    public function createCopyButton($dom, $class, $id, $icon, $text, $clipboard, $tooltip) {
    ...
    public function createLinkButton($dom, $class, $id, $icon, $href, $target, $text, $clipboard, $tooltip) {
